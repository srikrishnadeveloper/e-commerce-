          ...
          >
            ...
            >
              ...
              {index === activeIndex && (
                <button 
                  ref={buttonRef}
                  className="inline-flex items-center bg-transparent border-2 border-white px-4 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-lg font-medium transition-all duration-300 hover:bg-white hover:text-black group text-white"
                >
                  {slide.button}
                  <svg 
                    width="12" 
