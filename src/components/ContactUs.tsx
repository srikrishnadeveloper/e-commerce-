                ...
                <div className="flex space-x-4 pt-4">
                  {socialMedia.length > 0 ? (
                    socialMedia.map((social: any, index: number) => (
                      ...
                      >
                        {social.icon ? (
                          <div dangerouslySetInnerHTML={{ __html: social.icon }} className="w-5 h-5 text-gray-600" />
                        ) : (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <button
                    ...
                    className="w-full bg-black text-white py-4 px-8 rounded-lg font-medium hover:bg-gray-800 transition-colors duration-200 text-lg disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
