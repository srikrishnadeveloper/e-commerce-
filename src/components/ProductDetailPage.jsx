    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="min-h-[300px] lg:min-h-[400px]" style={{ fontFamily: "'Albert Sans', sans-serif" }}>
            {activeTab === 'description' && (
              <div className="grid gap-6 lg:gap-8 lg:grid-cols-2">
                <div>
                  <h3 className="text-lg lg:text-xl font-bold text-red-500 mb-4 lg:mb-6" style={{ fontFamily: "'Albert Sans', sans-serif" }}>Features</h3>
                  <ul className="space-y-3 text-red-500 text-sm lg:text-base">
        ...
        <div className="border-t border-gray-200 pt-16 mt-16">
          <h2 className="text-2xl font-bold text-red-500 mb-10" style={{ fontFamily: "'Albert Sans', sans-serif" }}>People Also Bought</h2>
                ...
                >
                  {[...relatedProducts, ...relatedProducts, ...relatedProducts, ...relatedProducts, ...relatedProducts].map((product, index) => (
                    <Link to={`/product/${product.id}`} key={`infinite-${product.id}-${index}`} className="group flex-shrink-0" style={{ width: 'calc(25% - 1.125rem)' }}>
                      ...
                      <h3 className="font-semibold text-red-500 mb-2" style={{ fontFamily: "'Albert Sans', sans-serif" }}>{product.name}</h3>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="font-bold text-red-500" style={{ fontFamily: "'Albert Sans', sans-serif" }}>${product.price}</span>
                        <span className="text-sm text-red-400 line-through" style={{ fontFamily: "'Albert Sans', sans-serif" }}>${product.originalPrice}</span>
                      </div>
