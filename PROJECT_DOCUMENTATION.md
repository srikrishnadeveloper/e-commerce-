...
│   │  (Customer   │    │  (Admin Panel)   │    │  (Experimental)   │    │
│   │   Store)     │    │                  │    │                   │    │
│   │   :5177      │    │     :8091        │    │      :5175        │    │
│   └──────┬───────┘    └────────┬─────────┘    └─────────┬─────────┘    │
│          │                     │                        │              │
...
├── adminbackend/         # Experimental admin UI backend
...
| **Nodemailer** | 7.0.x | Email sending |
...
| **Admin Backend UI** | 5175 | Experimental admin UI | `cd adminbackend && npm run dev` |
...
- `adminbackend` is experimental and may have limited functionality
